...
<head>
    ...
    <!-- Morris Charts CSS -->
    <link href="/webjars/github-com-BlackrockDigital-startbootstrap-sb-admin/3.3.7/css/plugins/morris.css" rel="stylesheet">
...
<body>
    ...
    <script src="/webjars/github-com-BlackrockDigital-startbootstrap-sb-admin/3.3.7/js/plugins/morris/raphael.min.js"></script>
    <script src="/webjars/github-com-BlackrockDigital-startbootstrap-sb-admin/3.3.7/js/plugins/morris/morris.min.js"></script>
    <script src="/webjars/github-com-BlackrockDigital-startbootstrap-sb-admin/3.3.7/js/plugins/morris/morris-data.js"></script>

    <!-- Flot Charts JavaScript -->
    <!--[if lte IE 8]><script src="js/excanvas.min.js"></script><![endif]-->
    <script src="/webjars/github-com-BlackrockDigital-startbootstrap-sb-admin/3.3.7/js/plugins/flot/jquery.flot.js"></script>
    <script src="/webjars/github-com-BlackrockDigital-startbootstrap-sb-admin/3.3.7/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="/webjars/github-com-BlackrockDigital-startbootstrap-sb-admin/3.3.7/js/plugins/flot/jquery.flot.resize.js"></script>
    <script src="/webjars/github-com-BlackrockDigital-startbootstrap-sb-admin/3.3.7/js/plugins/flot/jquery.flot.pie.js"></script>
    <script src="/webjars/github-com-BlackrockDigital-startbootstrap-sb-admin/3.3.7/js/plugins/flot/flot-data.js"></script>
